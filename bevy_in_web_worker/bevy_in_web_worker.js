...
* @param {number} y
*/
__exports.left_bt_down = function(ptr, obj, x, y) {
...
* @param {bigint} ptr
*/
__exports.left_bt_up = function(ptr) {
    wasm.left_bt_up(ptr);
};
...
*/
__exports.set_auto_animation = function(ptr, needs_animate) {
...
* @param {bigint} ptr
*/
__exports.release_app = function(ptr) {
