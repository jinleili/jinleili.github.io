...
function RippleEffect(canvas, imgURL){
 ...
 var Ripples =function() {
		...
		var backgroundUrl = imgURL;
		if (backgroundUrl == null) return;
		console.log("fdafdsafd--00", imgURL);

		this.interactive = Ripples.DEFAULTS.interactive;
		this.resolution = Ripples.DEFAULTS.resolution;
		this.textureDelta = new Float32Array([1 / this.resolution, 1 / this.resolution]);

		this.perturbance = Ripples.DEFAULTS.perturbance;
		this.dropRadius = Ripples.DEFAULTS.dropRadius;
...
console.log("fdafdsafd");
		};
		image.src = backgroundUrl;
		console.log("fdafdsafd--0");
	...
	Ripples.prototype = {
		...
		computeTextureBoundaries: function() {
			...
			this.renderProgram.uniforms.bottomRight = new Float32Array([
				this.renderProgram.uniforms.topLeft[0] + 0.3,
				this.renderProgram.uniforms.topLeft[1] +0.3
			]);
